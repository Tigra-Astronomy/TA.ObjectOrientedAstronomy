...
// 
// File: Vsop87Term.cs  Last modified: 2016-10-08@23:27 by Tim Long

namespace TA.ObjectOrientedAstronomy.OrbitEngines.VSOP87
    {
    /// <summary>
    ///     Represents a single term for a VSOP87 computation. Each instance of this class corresponds to one record in
    ///     the raw VSOP87 data file.
    /// </summary>
    /// <remarks>
    ///     <para>
    ///         The VSOP87 model of planetary motion (Jean Meeus, 1991, Astronomical Algorithms, Willmann-Bell, Richmond VA,
    ///         chapter 31 and appendix II; P. Bretagnon, G. Francou, 1988, Planetary theories in rectangular and spherical
    ///         variables, VSOP87 solutions, Astronomy and Astrophysics, 202, p.309ff) gives us polynomials in time for each
    ///         planet Mercury to Uranus that are independent of the other planets. There are three polynomials, one each
    ///         for geometric heliocentric longitude, latitude and distance. Presumably they are heliocentric and not
    ///         barycentric and the vectors point to the planets' centres and not the centres of their planet-moon systems.
    ///     </para>
    ///     <para>
